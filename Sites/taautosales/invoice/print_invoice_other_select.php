...
<div class="roundedcornr_box" style="width:850px">
...
$(document).ready(function(){ 
	...
	$('#div_show_result').load('../car/list_reserve_menu_up.php?option=invoice_other');
	
	// ค้นหาเลขที่การจอง
    $("#txt_res_id").autocomplete({
        source: "../car/update_reserve_api.php?cmd=autocomplete",
        minLength:1
    });
	...
	function search(){
		...
		$('#div_show_result').empty();
		$.post('../car/list_reserve_menu_up.php',{
			condition: $("#ddl_condition").val(),
			keyword: str_keyword,
			option: 'invoice_other'
		},
		function(data){

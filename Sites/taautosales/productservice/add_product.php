...
<div>
  <div style="float:left"><b>ADD Product </b></div><div style="float:right; "><button style="width:150px;" onclick="window.location='product.php'">Back to list product</button></div><br />
  <div>
  ...
  <tr>
	...
	<select name="cb_product" id="cb_product">
		<option value="">กรุณาเลือกตาราง</option>
							...
							?>
								<option value="<?php echo "$table_name"; ?>" <?php if($table_id == '1') echo "selected"; ?>><?php echo "$table_name" ; ?></option>
							<?php
								}
							?>
	</select>

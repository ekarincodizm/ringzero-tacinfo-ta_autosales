...
if($cmd == "save"){
    ...
    if($radio_buy_type == 1){
        ...
        values ('$vp_id','$txt_detail','$_SESSION[ss_iduser]',DEFAULT,DEFAULT,'$txt_cash_amt',DEFAULT,DEFAULT,'$nowdate','$rs_jobid','R',DEFAULT)";
        ...
        $insert_voucher="insert into account.\"VoucherDetails\" (\"vc_id\",\"vc_detail\",\"marker_id\",\"approve_id\",\"receipt_id\",\"cash_amt\",\"chq_acc_no\",\"chque_no\",\"do_date\",\"job_id\",\"vc_type\",\"acb_id\") 
        values ('$vp_id','$txt_detail','$_SESSION[ss_iduser]',DEFAULT,DEFAULT,DEFAULT,'$cb_cheque_acid','$txt_cheque_id','$nowdate','$rs_jobid','R',DEFAULT)";
        $rs_voucher=pg_query($insert_voucher);
        if(!$rs_voucher){
            $status++;
        }

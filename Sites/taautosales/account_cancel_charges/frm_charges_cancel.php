...
<table cellpadding="3" cellspacing="0" border="0" width="100%">
	...
	<tr>
		<td>หมายเหตุการขอยกเลิก : </td><td><textarea name="cancel_note" id="cancel_note" cols="60" rows="4"></textarea></td>
	</tr>
</table>
<br>
<div style="text-align:right">
	<input type="button" name="btn_save" id="btn_save" value="ขอยกเลิก">
</div>
</body>
</html>
<script>
$('#btn_save').click(function(){
	...
	if(document.getElementById("cancel_note").value == '')
	{
		alert('กรุณาระบุ หมายเหตุการขอยกเลิก');
		return false;
	}
	
	$('body').append('<div id="divdialogconfirm"></div>');
	$("#divdialogconfirm").text('ต้องการขอยกเลิกใช่หรือไม่ ?');

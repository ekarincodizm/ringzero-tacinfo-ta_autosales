...
$("#txt_name").autocomplete({
    source: "customer_edit_address_api.php?cmd=autocomplete",
    minLength:1,
    select: function(event, ui) {
        if(ui.item.value != 'ไม่พบข้อมูล' && ui.item.value != ''){
            ...
            $('#divshow').load('customer_edit_address_api.php?cmd=show&id='+arr_plan[0]);
        }
    }
});
</script>

...
<tr bgcolor="#F0F0F0">
    <td width="20%" style="font-weight:bold">เลขที่สำคัญ</td>
    <td><input type="text" name="txt_no" id="txt_no" size="20"></td>
</tr>
<!--<tr bgcolor="#F0F0F0">
    <td width="20%" style="font-weight:bold">เลขที่ใบเสร็จรับเงินเดิม</td>
    <td><input type="text" name="txt_origin_doc_no" id="txt_origin_doc_no" size="20"></td>
</tr>-->
<tr bgcolor="#F0F0F0">
...
$('#btnSave').click(function(){
	if( $('#txt_no').val() == "" ){
		alert("กรุณา ระบุเลขที่สำคัญ");
		return false;
	}/*else if( $('#txt_origin_doc_no').val() == "" ){
		alert("กรุณา ระบุเลขที่ใบเสร็จเดิม");
		return false;
    ...
    $.post('cancel_receipt_api.php',{
        ...
        txt_no: $('#txt_no').val(),
		//old_doc_no: $('#txt_origin_doc_no').val(),

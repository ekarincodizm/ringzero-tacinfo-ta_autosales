...
?>
		...
		<div id="search" style="width:60%; margin-left:auto;margin-right:auto;" >
		...
		<div id="div_search_result" style="margin-top:10px"></div>
      </div>
...
$(document).ready(function(){
	...
	$("#txtpo_id").autocomplete({
        source: "po_autocomplete.php?cmd=po_id",
        minLength:1
   
	});
	
	$("#txtvender").autocomplete({
        source: "po_autocomplete.php?cmd=vender",
        minLength:1
	});
});

...
$up_qry="Update   \"Products\" SET \"name\"='$p_name',cost_price='$p_costprice',sale_price='$p_saleprice',use_vat='$usevat',type_rec='$type_rec',cancel='$rd_cancel',link_table='$linktable' where product_id='$p_id' ";
